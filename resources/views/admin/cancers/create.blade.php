        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header d-flex align-items-center ">
                    <h3 class="mb-0 mr-5 btn btn-dark">التوعية لمرض جديد</h3>
                ...
                <div class="container-fluid mt-4">
                    ...
                    <form action="{{ route('dashboard.cancer.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf

                        <div class="form-group">
                            <label for="name" class="col-form-label"> اسم المرض </label>
